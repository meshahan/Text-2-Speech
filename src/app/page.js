      ...
      <div className="grid grid-cols-2 grid-rows-[4fr,1fr] gap-5 p-5 bg-white rounded-lg shadow-lg w-[1300px] h-[620px] max-md:grid-cols-1 max-md:w-full max-md:h-full">
        <div className="grid grid-rows-[44px,1fr] row-span-full">
          <div className="pl-2 border border-gray-300 rounded-t-lg bg-gray-100 flex justify-end items-center">
            <button
              className="px-4 py-2 text-lg bg-blue-400 text-bg-emerald-700 font-semibold rounded-tr-lg transition duration-300 hover:bg-blue-700"
              onClick={handleClear}
            >
              Clear
            </button>
          ...
          <textarea
            className="w-full h-full p-4 text-base mb-5 rounded-b-lg border text-black border-gray-300 shadow-inner bg-slate-300 from-white to-gray-200 transition duration-300 focus:border-blue-600 focus:shadow focus:shadow-blue-200 focus:outline-none focus:bg-gradient-to-br"
            placeholder="Enter your text here..."
            value={text}
            onChange={(e) => setText(e.target.value)}
          />
        </div>
        <div className="relative flex flex-col items-center justify-center gap-4 h-[70%] p-5 bg-gradient-to-br from-gray-900 to-gray-300 rounded-lg shadow-lg before:content-['Voice_Filter'] before:absolute before:top-[-10px] before:left-[-10px] before:bg-blue-600 before:text-white before:px-2 before:rounded before:font-bold before:text-sm before:shadow-md max-md:h-full max-md:py6">
          <select
            className="w-full p-3 text-base rounded-lg border border-gray-300 bg-lime-400 text-black font-semibold"
        ...
        <div className="flex flex-col justify-end">
          ...
          <button
            className="px-5 py-3 text-lg font-bold mt-4 rounded-lg bg-purple-800 text-white cursor-pointer transition duration-300 hover:bg-blue-700 shadow-lg flex items-center justify-center relative h-[60%]"
